...
<use xlink:href="#icon-arrow" />
    ...
    <li class="submenu__item ">
            <a class="link" href="/collections/bst-nang-tho" title="BST Nàng Thơ">BST Nàng Thơ</a>
        </li>
    ...
    <li class="submenu__item ">
            <a class="link" href="/collections/bst-black-swan" title="BST Black Swan">BST Black Swan</a>
        </li>
...
<a href="/blogs/news" class="menu-item__link" title="Blog">
                    <img src="//theme.hstatic.net/200000685745/1001041408/14/menu_icon_3.png?v=44" alt="Blog" />
                        <span>
    Blog</span>	 
    </a>			
...
<div class='menu-overlay'>
    ...
    <defs>
        <symbol class="icon " id="icon-cart" viewBox="0 0 16 19" fill="none"><path
...
<svg style="display:none">
    <defs>
        <symbol id="icon-minus" class="icon icon-minus" viewBox="0 0 16 2"
            fill="none">
            <path
...
<svg style="display:none">
    <defs>
        <symbol id="icon-plus" class="icon icon-plus" viewBox="0 0 93.562 93.562"
            fill="none">
            <path
...
<svg style="display:none">
    <defs>
        <symbol class="icon icon-arrow" id="icon-arrow" viewBox="0 0 490.8 490.8"
...
<svg style="display:none">
    <defs>
        <symbol id="icon-search" class="icon icon-search"
...
<svg style="display:none">
    <defs>
        <symbol id="icon-share" width="14" height="16" fill="none"
            viewBox="0 0 14 16">
            <path fill="#000"
            ...
            <div class="row">
                <div
                    ...
                    <div class="more-view-wrapper clearfix">
                        <div class="thumbs_quickview owl_nav_custome1"
                            id="thumbs_list_quickview">
                            <ul
                                class="product-photo-thumbs quickview-more-views-owlslider not-thuongdq"
    ...
    <a href="${url}">	
        <a class="product-images1  pos-relative embed-responsive embed-responsive-1by1" href=""  title="${title}">
            <img loading="lazy" class="img-fluid" src="${image_url}" alt="${title}">
                    ...
                    <img src="//theme.hstatic.net/200000685745/1001041408/14/ega-product-gift.png?v=44" alt="product gift">
                </div>
                            </a>
    </a>
</div>
...
<div class="cart-cta">
    ...
    <img loading="lazy" src="//theme.hstatic.net/200000685745/1001041408/14/delivery-icon.png?v=44" alt="delivery" ->
...
<div id="popup-cart" class="popcart">
    <div id="popup-cart-desktop" class="clearfix">
        ...
        <div class="wrap_popup">
            ...
            <div style="width: 17%;" class="text-center">Thành tiền</div>
                ...
                <div class="tfoot-popup">
                    ...
                    <div class="tfoot-popup-2 clearfix">
                        <a class="button btn-continue close-pop" title="Tiếp tục mua hàng"
            ...
            <a title="Close" class="close-modal quickview-close close-pop"
                href="javascript:;" onclick="$('#popup-cart').modal('hide');"><i
                    ...
                    if (value.length) {   
                        ...
                        if(link_img0=="null" || link_img0 =='' || link_img0 ==null){
                            ...
                            var ItemDropCart = [{
                              url: item.url,
                              image_url: link_img0,
                              price: Haravan.formatMoney(item.price, '0'),
                              title: item.title,
                              buttonQty: buttonQty,
                        ...
                        jQuery('<div class="pd"><div class="top-subtotal">Tổng tiền tạm tính: <span class="price price_big">' + Haravan.formatMoney(cart.total_price, "0") + '</span></div></div>').appendTo(table);
                ...
                if (key === 'items') {
                    ...
                    if (value.length) {  
                        ...
                        jQuery.each(value, function(i, item) {
                            ...
                            if(item.variant_title == 'Default Title'){
                                var ItemCartPage = [{
                                  ...
                                  quanty: item.quantity,
                                  variant_title: item.variant_title,
                                  price_quanty: Haravan.formatMoney(item.price * item.quantity, "0"),
                                  id_item: item.variant_id,
                                  variant_title: ''
                                }]
                            }else {
                        ...
                        var PriceTotalCheckout = [{
                              price_total: Haravan.formatMoney(cart.total_price, "0")
                        }];				
...
Haravan.updateCartPopupForm = function(cart, cart_summary_id, cart_count_id) {
    ...
    jQuery('.total-price').html(Haravan.formatMoney(cart.total_price, "0"));
        updateCartDesc(cart);
    }
...
function updateCartDesc(data){
    var $cartPrice = Haravan.formatMoney(data.total_price, "0"),
             ...
             if (key === 'items') {    
                 jQuery.each(value, function(i, item) {	
                     if(item.variant_id == variantId){
                         $('.productid-'+variantId).find('.cart-price span.price').html(Haravan.formatMoney(item.price * item.quantity, "0"));
...
<div class="addThis_listSharing ">
    ...
    <a href="#" id="back-to-top"
        class="backtop back-to-top d-flex align-items-center justify-content-center"
        title="Lên đầu trang">
