...
@section('content')
    ...
    <section class="section awe-section-7 section-section_product_top_1">

        <section class="section_product_top section">
            <div class="container  card border-0 ">

                <div
                    class="title_module_main heading-bar e-tabs  d-flex align-items-center flex-wrap heading-style2 justify-content-center">
                    <h2 class="heading-bar__title">Bộ sưu tập Eunoia by AN</h2>

                    <div class="tabs-select-wrap position-relative select-hide">
                        <div class="tabs-select"><span>Nàng Thơ</span>
                ...
                <div class='e-tabs'>
                    ...
                    <div id="product_top_1-tab-1" class="tab-content content_extabcurrent">
                        ...
                        <div class="row mt-3 one_row" style="--limit-column: 10" data-section="tab-section">
...
<div class="item-color-chosen">
                    ...
                    <div id="product_top_1-tab-3" class="tab-content content_extab">
                        ...
                        <div class="col-12">
                            <p class="a-center mt-3">Hiện tại chưa có sản phẩm nào trong danh mục
                                này!...</p>
                        </div>
    ...
    <section class="section awe-section-8 section-section_video">
        <section class="section_video section position-relative">
            <div class="container border-0">

                <div class="item video-item"
                    data-src="https://www.youtube.com/watch?v=31K8rfxWzwk?width=800&height=450&autoplay=1">
                    <a class="d-block pos-relative embed-responsive embed-responsive-16by9"
                        href="https://www.youtube.com/watch?v=31K8rfxWzwk?width=800&amp;height=450&amp;autoplay=1"
                        data-rel="prettyPhoto[product-gallery]">

                        <picture>
                            <source media="(max-width: 480px)"
                                srcset="{{ asset('assets/theme/200000685745/1001041408/14/section_video_bg_large.') }}jpg?v=44">
                            <source media="(max-width: 991px)"
                                srcset="{{ asset('assets/theme/200000685745/1001041408/14/section_video_bg.jpg?v=') }}44">
        ...
        <section class="section_product_top section">
            <div class="container  card border-0 ">
                ...
                <div
                    ...
                    <div class="tabs-select-wrap position-relative select-hide">
                        <div class="tabs-select"><span>Sản phẩm hot</span>
                ...
                <div class="imgtext_body ">
                    ...
                    <div class="imgtext_content_wrap">
                        <div class="imgtext_content">
                            <h3 class="imgtext-title">Xu hướng thời trang 2022</h3>
                            <p class="imgtext-desc">Khoe eo! Mùa Hè mang đến lời mời gọi hãy để
                                chiếc eo thon là tâm điểm phong cách. BST Miu Miu ngập tràn crop top
                                với hơi hướng Y2K đầy sức sống. Versace cũng cho thấy làn da rám nắng
...
<use xlink:href="#icon-instagram"/>
    ...
    <section class="section awe-section-14 section-section_blog">
       ...
       aspect-ratio rounded overflow-hidden"
                                    href="blogs/news/maika-ket-bo-suu-tap-nha-eunoia-by-an-bang-loi-ca-a-whole-new-world.html"
      ...
      --height: 231;'>
                                ...
                                <div class="content_blog clearfix card-body px-0 py-2">
                                    ...
                                    <p class="justify">
                                        <span class="art-summary">
                                            ...
                                            Mới đây, Eunoia’s Wonderland Fashion Show đã diễn ra tại Hà Nội nhận
                                            được sự chú ý của đông đảo người hâm mộ thời trang. Kết...
                            ...
                            <div class='section_blog_right pl-0'>
                                <div class="blogwp clearfix media">
                                    ...
                                    <a class="image-blog text-center mr-2 mr-md-3"
                                        href="blogs/news/dan-mau-nhi-chan-tran-trinh-dien-tai-eunoia-s-wonderland-fashion-show.html"
                                    ...
                                    <div class="content_blog clearfix media-body ">
                                        ...
                                        <p class="justify lead d-none d-md-block ">
                                            ...
                                            &nbsp;Khoác lên mình những thiết kế thời trang đầy màu sắc, dàn mẫu
                                            nhí đã mang đến cho khán giả...
                                ...
                                <div class="blogwp clearfix media">
                                    ...
                                    <div class="content_blog clearfix media-body ">
                                        ...
                                        <p class="justify lead d-none d-md-block ">
                                            ...
                                            mong chờ khi mang thông điệp về sự khát...
                                ...
                                <div class="blogwp clearfix media">
                                    ...
                                    <div class="content_blog clearfix media-body ">
                                        ...
                                        <p class="justify lead d-none d-md-block ">
                                            ...
                                            chức sẽ diễn ra vào ngày 26/11/2022 tại Sheraton...
                    ...
                    <div class="text-center mt-3">
                        <a href="blogs/news.html" title="Xem tất cả" class="btn btn-main btn-icon btn-pill">
                            Xem tất cả
